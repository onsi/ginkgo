...
- Ginkgo now summarizes any spec failures that occured at the end of the test run.  This is the new default behavior and can be turned off with `--summarize=false`
