	...
	BeforeEach(func() {
		report = types.Report{
			...
			SpecReports: types.SpecReports{
				...
				S(types.NodeTypeIt, "C", cl0, types.SpecStatePending, CLabels(Label("owner:org")), Label("owner:team")),
				S(types.NodeTypeIt, "D", cl0, types.SpecStatePanicked, CLabels(Label("owner:org")), STD("some captured stdout\n"),
					SE(types.SpecEventNodeStart, types.NodeTypeIt, "A", cl0),
