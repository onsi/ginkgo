...
- [Why Ginkgo?](#why-ginkgo)
- [Getting Started](#getting-started)
  - [Installing Ginkgo](#installing-ginkgo)
  - [Your First Ginkgo Suite](#your-first-ginkgo-suite)
  - [Bootstrapping a Suite](#bootstrapping-a-suite)
    - [Mental Model: Go modules, packages, and tests](#mental-model-go-modules-packages-and-tests)
    - [Adding Specs to a Suite](#adding-specs-to-a-suite)
- [Writing Specs](#writing-specs)
  - [Spec Subjects: It](#spec-subjects-it)
  - [Extracting Common Setup: BeforeEach](#extracting-common-setup-beforeeach)
  - [Organizing Specs With Container Nodes](#organizing-specs-with-container-nodes)
  - [Mental Model: How Ginkgo Traverses the Spec Hierarchy](#mental-model-how-ginkgo-traverses-the-spec-hierarchy)
    - [Nodes only belong in Container Nodes](#nodes-only-belong-in-container-nodes)
    - [No Assertions in Container Nodes](#no-assertions-in-container-nodes)
    - [Avoid Spec Pollution: Don't Initialize Variables in Container Nodes](#avoid-spec-pollution-dont-initialize-variables-in-container-nodes)
  - [Separating Creation and Configuration: JustBeforeEach](#separating-creation-and-configuration-justbeforeeach)
  - [Spec Cleanup: AfterEach and DeferCleanup](#spec-cleanup-aftereach-and-defercleanup)
    - [Cleaning up our Cleanup code: DeferCleanup](#cleaning-up-our-cleanup-code-defercleanup)
    - [Separating Diagnostics Collection and Teardown: JustAfterEach](#separating-diagnostics-collection-and-teardown-justaftereach)
  - [Suite Setup and Cleanup: BeforeSuite and AfterSuite](#suite-setup-and-cleanup-beforesuite-and-aftersuite)
  - [Mental Model: How Ginkgo Handles Failure](#mental-model-how-ginkgo-handles-failure)
  - [Logging Output](#logging-output)
  - [Documenting Complex Specs: By](#documenting-complex-specs-by)
  - [Table Specs](#table-specs)
    - [Mental Model: Table Specs are just Syntactic Sugar](#mental-model-table-specs-are-just-syntactic-sugar)
    - [Generating Entry Descriptions](#generating-entry-descriptions)
- [Running Specs](#running-specs)
  - [Mental Model: Ginkgo Assumes Specs are Independent](#mental-model-ginkgo-assumes-specs-are-independent)
  - [Spec Randomization](#spec-randomization)
  - [Spec Parallelization](#spec-parallelization)
    - [Mental Model: How Ginkgo Runs Parallel Specs](#mental-model-how-ginkgo-runs-parallel-specs)
    - [Discovering Which Parallel Process a Spec is Running On](#discovering-which-parallel-process-a-spec-is-running-on)
    - [Parallel Suite Setup and Cleanup: SynchronizedBeforeSuite and SynchronizedAfterSuite](#parallel-suite-setup-and-cleanup-synchronizedbeforesuite-and-synchronizedaftersuite)
    - [The ginkgo CLI vs go test](#the-ginkgo-cli-vs-go-test)
  - [Mental Model: Spec Decorators](#mental-model-spec-decorators)
  - [Serial Specs](#serial-specs)
  - [Ordered Containers](#ordered-containers)
    - [Setup in Ordered Containers: BeforeAll and AfterAll](#setup-in-ordered-containers-beforeall-and-afterall)
    - [Failure Handling in Ordered Containers](#failure-handling-in-ordered-containers)
    - [Combining Serial and Ordered](#combining-serial-and-ordered)
  - [Filtering Specs](#filtering-specs)
    - [Pending Specs](#pending-specs)
    - [Skipping Specs](#skipping-specs)
    - [Focused Specs](#focused-specs)
    - [Spec Labels](#spec-labels)
    - [Location-Based Filtering](#location-based-filtering)
    - [Description-Based Filtering](#description-based-filtering)
    - [Combining Filters](#combining-filters)
  - [Repeating Spec Runs and Managing Flaky Specs](#repeating-spec-runs-and-managing-flaky-specs)
  - [Interrupting, Aborting, and Timing Out Suites](#interrupting-aborting-and-timing-out-suites)
  - [Running Multiple Suites](#running-multiple-suites)
- [Reporting and Profiling Suites](#reporting-and-profiling-suites)
  - [Controlling Ginkgo's Output](#controlling-ginkgos-output)
    - [Controlling Verbosity](#controlling-verbosity)
    - [Other Settings](#other-settings)
  - [Reporting Infrastructure](#reporting-infrastructure)
  - [Generating machine-readable reports](#generating-machine-readable-reports)
  - [Generating reports programmatically](#generating-reports-programmatically)
    - [Getting a report for the current spec](#getting-a-report-for-the-current-spec)
    - [Reporting Nodes - ReportAfterEach and ReportBeforeEach](#reporting-nodes---reportaftereach-and-reportbeforeeach)
    - [Reporting Nodes - ReportAfterSuite](#reporting-nodes---reportaftersuite)
  - [Attaching Data to Reports](#attaching-data-to-reports)
    - [Supported Args](#supported-args)
    - [Controlling Output](#controlling-output)
  - [Profiling your Suites](#profiling-your-suites)
    - [Computing Coverage](#computing-coverage)
    - [Other Profiles](#other-profiles)
- [Ginkgo and Gomega Patterns](#ginkgo-and-gomega-patterns)
  - [Recommended Continuous Integration Configuration](#recommended-continuous-integration-configuration)
  - [Supporting Custom Suite Configuration](#supporting-custom-suite-configuration)
    - [Supporting Custom Suite Configuration: Environment Variables](#supporting-custom-suite-configuration-environment-variables)
    - [Supporting Custom Configuration: Custom Command-Line Flags](#supporting-custom-configuration-custom-command-line-flags)
    - [Overriding Ginkgo's command-line configuration in the suite](#overriding-ginkgos-command-line-configuration-in-the-suite)
  - [Dynamically Generating Specs](#dynamically-generating-specs)
  - [Shared Behaviors](#shared-behaviors)
  - [Table Specs Patterns](#table-specs-patterns)
  - [Patterns for Asynchronous Testing](#patterns-for-asynchronous-testing)
    - [Testing an in-process Asynchronous Service.](#testing-an-in-process-asynchronous-service)
    - [Testing Local Processes](#testing-local-processes)
    - [Testing Blocking Functions](#testing-blocking-functions)
    - [Testing External Systems](#testing-external-systems)
  - [Patterns for Parallel Integration Specs](#patterns-for-parallel-integration-specs)
    - [Managing External Processes in Parallel Suites](#managing-external-processes-in-parallel-suites)
    - [Managing External Resources in Parallel Suites: Files](#managing-external-resources-in-parallel-suites-files)
    - [Managing External Resources in Parallel Suites: Ports](#managing-external-resources-in-parallel-suites-ports)
    - [Patterns for Testing against Databases](#patterns-for-testing-against-databases)
      - [A Database for Every Spec](#a-database-for-every-spec)
      - [A Database for Every Parallel Process](#a-database-for-every-parallel-process)
    - [Patterns for Testing against Singletons](#patterns-for-testing-against-singletons)
    - [Some Subtle Parallel Testing Gotchas](#some-subtle-parallel-testing-gotchas)
  - [Benchmarking Code](#benchmarking-code)
  - [Building Custom Matchers](#building-custom-matchers)
- [Decorator Reference](#decorator-reference)
    - [Node Decorators Overview](#node-decorators-overview)
    - [The Serial Decorator](#the-serial-decorator)
    - [The Ordered Decorator](#the-ordered-decorator)
    - [The Label Decorator](#the-label-decorator)
    - [The Focus and Pending Decorator](#the-focus-and-pending-decorator)
    - [The Offset Decorator](#the-offset-decorator)
    - [The CodeLocation Decorator](#the-codelocation-decorator)
    - [The FlakeAttempts Decorator](#the-flakeattempts-decorator)
- [Ginkgo CLI Overview](#ginkgo-cli-overview)
  - [Running Specs](#running-specs-1)
  - [Precompiling Suites](#precompiling-suites)
  - [Watching for Changes](#watching-for-changes)
  - [Generators](#generators)
  - [Creating an Outline of Specs](#creating-an-outline-of-specs)
