...
func init() {
	...
	flag.Int64Var(&(GinkgoConfig.ParallelNode), "parallel.node", 1, "This worker node's node number.  For running specs in parallel.")
	flag.Int64Var(&(GinkgoConfig.ParallelTotal), "parallel.total", 1, "The total number of worker nodes.  For running specs in parallel.")
